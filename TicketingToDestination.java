...
public class TicketingToDestination extends JFrame {
    ...
    private void buildUI() {
        ...
        // UI Header updated to say "To" instead of "From"
        JLabel toLabel = createLabel("To", TEXT_FROM, 48);
        toLabel.setBounds(0, scale(318), scale(1086), scale(60));
        mainContent.add(toLabel);
        ...
        confirmBtn.addActionListener(e -> {
            ...
            // Save selection to the "Arrival" tracking state
            TicketingDevice.selectedTo = fullLocation.toString();

            // Re-open TicketingDevice dashboard with fresh state loading
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new TicketingToDestination().setVisible(true));
    }
}
